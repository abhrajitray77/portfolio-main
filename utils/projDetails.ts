const ProjectDetails = [
    {
      name: "Enactus SMIT",
      desc:
        "The official website of Enactus SMIT built using React.js, TailwindCSS, Framer Motion, and Firebase.",
      vidSrc:
        "https://github.com/abhrajitray77/Enactus-smit-final/assets/67530432/b160660a-d241-4e2f-90ad-a7484cbdadb5",
    ...
    },
    {
      ...
      desc:
        "ReactJS Chrome Extension with GPT-3 integration and Webpage text clipping functionality. (My OpenAI credits for API calls are over)",
      vidSrc:
    ...
    },
    {
      ...
      desc:
        "An AI chatbot built using Next.js 13, Tailwind CSS, and Typescript. Uses the OpenAI API to generate responses. Firebase for Google authentication for multiple users and Firestore for storing the user's chat history. (My OpenAI credits for API calls are over)",
      vidSrc:
    ...
    },
    {
      ...
      desc:
        "A site that fetches data from a MongoDB database to show the schedule of doctors from various departments.",
      vidSrc:
        "https://github-production-user-asset-6210df.s3.amazonaws.com/67530432/240319234-ccc3a742-ada3-4877-a6ca-5e42ecd95758.mp4",
    ...
    },
    {
      ...
      desc:
        "A Netflix landing page Clone built with Typescript, Next.js, and TailwindCSS that uses the TMDB API to fetch the movie details and posters.",
      vidSrc:
